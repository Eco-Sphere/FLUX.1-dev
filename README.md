...
def split_forward_gather(input_, world_size, rank, dim):
    return input_.chunk(world_size, dim=dim)[rank]
...
def gather_forward_split_unequal(input_, group, world_size):
    b, s, h = input_.shape
